...
class GenerationMixin:
    ...
    def prepare_inputs_for_generation(
        ...
        timeseries_input_ids=None, timeseries_attention_mask=None,
        **kwargs,
    ):
        """
        ...
        if timeseries_input_ids is not None:
            model_inputs["timeseries_input_ids"] = timeseries_input_ids
        if timeseries_attention_mask is not None:
            model_inputs["timeseries_attention_mask"] = timeseries_attention_mask
    ...
    def _expand_inputs_for_generation(
        ...
        timeseries_input_ids: Optional[torch.LongTensor] = None,
        timeseries_attention_mask: Optional[torch.LongTensor] = None,
        **model_kwargs,
        ...
        timeseries_input_ids = _expand_tensor(timeseries_input_ids)
        timeseries_attention_mask = _expand_tensor(timeseries_attention_mask)
        ...
        # Inject expanded time series tensors back into model_kwargs
        if timeseries_input_ids is not None:
            model_kwargs["timeseries_input_ids"] = timeseries_input_ids
        if timeseries_attention_mask is not None:
            model_kwargs["timeseries_attention_mask"] = timeseries_attention_mask
        ...
        **kwargs,
        ...
        if generation_mode == GenerationMode.ASSISTED_GENERATION:
            ...
            result = self._beam_search(
                input_ids, # @Viktor pass ts ids here
                logits_processor=prepared_logits_processor,
                stopping_criteria=prepared_stopping_criteria,
                generation_config=generation_config,
                synced_gpus=synced_gpus,
    ...
    def _beam_search(
        ...
        generation_config: GenerationConfig,
        synced_gpus: bool,
        **model_kwargs, # @Viktor add ts ids (and ts attn mask)
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            model_inputs.update({"output_attentions": output_attentions} if output_attentions else {})
            model_inputs.update({"output_hidden_states": output_hidden_states} if output_hidden_states else {})
            # @Viktor add ts ids to model_inputs
